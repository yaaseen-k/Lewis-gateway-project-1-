...
describe("Lewis-Gateway — Happy Path", () => {
  // Fully-qualified base URL used for every cy.visit() below, so this spec
  // works regardless of whether cypress.config.js's baseUrl is being picked
  // up correctly (e.g. wrong working directory, or a legacy cypress.json
  // taking precedence on Cypress installs older than v10).
